...
(function () {
  ...
  const CITY_CONFIG = {
    label: "CLQ Copenhague",
    datasetUrl: "data/pois_explorer.json",
    defaultCenter: { lat: Number("55.6759"), lng: Number("12.56899") },
    lastPosKey: "copenhague_lastKnownPosition",
    cityKey: "copenhague",
  ...
  function isWalkInProgress() {
    return (
      ...
      localStorage.getItem("copenhague_walkInProgress") === "true" ||
  ...
  function updateTourSavedSummary() {
    ...
    if (!el) return;
    const idxRaw = localStorage.getItem("copenhague_currentIndex");
    const scoreRaw = localStorage.getItem("copenhague_score");
