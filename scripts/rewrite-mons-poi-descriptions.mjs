/**
 * Réécrit les descriptions POI Copenhague en textes visiteurs, sans formulation interne.
 * Usage: node scripts/rewrite-copenhague-poi-descriptions.mjs
 */
import fs from "fs";
...
function rewrite(lang, poi) {
  ...
  const city = poi.city || "Copenhague";
